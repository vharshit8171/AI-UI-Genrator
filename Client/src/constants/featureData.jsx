export const FEATURES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Generate content as plain text, JSON. Always get the format you need.",
        badge: null,
      },
    ],
  },
    ...
    items: [
      {
        ...
        title: "Code Download",
        desc: "Download your generated code instantly in multiple formats with a single click for easy sharing, backup or local development.",
        badge: "Popular",
      },
      {
        icon: (
        ...
        title: "Clean & Simple Workspace",
        desc: "Enjoy a distraction-free interface designed to help you focus on creating, editing, and managing content effortlessly.",
        badge: null,
      },
      {
        icon: (
